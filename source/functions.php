...
if ( ! function_exists( 'themissionary_setup' ) ) :
	...
	function themissionary_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'themissionary' ),
		) );
...
function themissionary_scripts() {
	wp_enqueue_style( 'themissionary-style', get_stylesheet_uri() );

	wp_enqueue_script( 'themissionary-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'themissionary-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
